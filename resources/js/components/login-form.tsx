...
export function LoginForm({
  ...
  return (
    <div className={cn("relative flex flex-col gap-6 min-h-screen justify-center items-center overflow-hidden", className)} {...props}>
      ...
      />
      <Card className="overflow-hidden p-0 z-10 shadow-xl transition-transform duration-300 hover:scale-[1.015] hover:shadow-2xl bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold animate-fade-in">Welcome back</h1>
              ...
              <Button type="submit" className="w-full transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg">
                Login
              </Button>
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 z-10" >
...
// Tailwind CSS custom animation styles (add these to your global CSS if not already present)
//
