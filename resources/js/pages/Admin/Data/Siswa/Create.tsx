...
interface SiswaCreateProps {
    kelasList: string[];
}

export default function SiswaCreate({ kelasList }: SiswaCreateProps) {
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <Card className="bg-white/80 shadow-md backdrop-blur-sm dark:bg-[#171717]/90 md:col-span-2">
                                    <CardHeader>
                                        ...
                                        <CardDescription>Informasi dasar siswa yang akan ditambahkan</CardDescription>
                                    </CardHeader>
                                ...
                                <Card className="bg-white/80 shadow-md backdrop-blur-sm dark:bg-[#171717]/90 md:col-span-2">
                                    <CardHeader>
                                        ...
                                        <CardDescription>Informasi akun login untuk siswa</CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <div className="space-y-2">
